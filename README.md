...
TC39 委员会中来自许多组织的数十人为此版本的发展都做出了重大的贡献。另外，一个能够支持 TC39 的 ECMAScript 规范发展的活跃社区已经出现。这个社区帮助审阅了大量的草案，输出了数千的 bug 报告、执行实施实验、贡献测试用例和在全球开发者社区对 ECMAScript 进行指导。不幸的是，我们没有办法再此对所有个人和组织的努力都一一进行识别和确认，但是感谢所有为 ECMAScript 发展做出贡献的人。
